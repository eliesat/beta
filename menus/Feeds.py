...
class Feeds(Screen):
	...
	def mList(self):
		...
		self.list.append((_("Feeds"), 1, _("فيدات مختلفة"), a))
	...
	def update_feeds(self):
		import requests
		url = 'https://raw.githubusercontent.com/eliesat/eliesatpanel/refs/heads/main/sub/feeds'
		response = requests.get(url)
		file_Path = '/usr/lib/enigma2/python/Plugins/Extensions/ElieSatPanel/sub/feeds'
...
def status_path():
	if fileExists("/usr/lib/enigma2/python/Plugins/Extensions/ElieSatPanel/sub/feeds"):
		status = "/usr/lib/enigma2/python/Plugins/Extensions/ElieSatPanel/sub/feeds"
	return status
	...
	def nList(self):
		...
		for line in open(status_path()):
			if "Package:" in line:
				...
				name2 = line.replace("\n","").split(r"(\s+)")[-1]
			elif "Status:" in line and "Feeds" in line:
