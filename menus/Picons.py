...
class FlexibleMenu(GUIComponent):
    ...
    def buildEntry(self):
        ...
        if "addons" not in self._cached_logos:
            logoPath = resolveFilename(SCOPE_PLUGINS, "Extensions/ElieSatPanel/assets/icons/picons.png")
...
class Picons(Screen):
       ...
       def __init__(self, session):
              ...
              # ---------------- Load Icon ----------------
              try:
                     icon_path = resolveFilename(SCOPE_PLUGINS, "Extensions/ElieSatPanel/assets/icons/picons.png")
       ...
       def check_plugin_update(self):
              try:
                     ...
                     if req.status_code != 200:
                            print("[Picons] Failed to fetch installer for update check")
                            return
                     ...
                     print("[Picons] check_plugin_update error:", e)
       ...
       def install_plugin_update(self, answer=False):
              ...
              self.session.open(
                     ...
                     finishedCallback=lambda r: print("[Picons] Plugin update finished:", r),
                     closeOnSuccess=True,
              )
