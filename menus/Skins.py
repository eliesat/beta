...
class Skins(Screen):
	...
	def mList(self):
		...
		self.list.append((_("SkinsParts"), 1, _("اضافات مختلفة خاصة بالسكينات"), a))
		self.list.append((_("Oe-based"), 2, _("سكينات"), a))
		self.list.append((_("Egami"), 3, _("سكينات"), a))
	...
	def update_skins(self):
		import requests
		url = 'https://raw.githubusercontent.com/eliesat/eliesatpanel/refs/heads/main/sub/skins'
		response = requests.get(url)
		file_Path = '/usr/lib/enigma2/python/Plugins/Extensions/ElieSatPanel/sub/skins'
...
def status_path():
	if fileExists("/usr/lib/enigma2/python/Plugins/Extensions/ElieSatPanel/sub/skins"):
		status = "/usr/lib/enigma2/python/Plugins/Extensions/ElieSatPanel/sub/skins"
	return status

class skinsparts(Screen):
	...
	def nList(self):
		...
		for line in open(status_path()):
			if "Package:" in line:
				...
				name2 = line.replace("\n","").split(r"(\s+)")[-1]
			elif "Status:" in line and "Sparts" in line:
