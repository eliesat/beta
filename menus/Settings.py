...
class FlexibleMenu(GUIComponent):
    ...
    def buildEntry(self):
        ...
        if "addons" not in self._cached_logos:
            logoPath = resolveFilename(SCOPE_PLUGINS, "Extensions/ElieSatPanel/assets/icons/settings.png")
...
class Settings(Screen):
       ...
       def __init__(self, session):
              ...
              # ---------------- Load Icon ----------------
              try:
                     icon_path = resolveFilename(SCOPE_PLUGINS, "Extensions/ElieSatPanel/assets/icons/settings.png")
              ...
              # Colored buttons same as Addons
       ...
       def run_selected_script(self):
              try:
                     ...
                     print("[Settings] run_selected_script error:", e)
       ...
       def check_plugin_update(self):
              try:
                     ...
                     if req.status_code != 200:
                            print("[Settings] Failed to fetch installer for update check")
                            return
                     ...
                     print("[Settings] check_plugin_update error:", e)
       ...
       def install_plugin_update(self, answer=False):
              ...
              self.session.open(
                     ...
                     finishedCallback=lambda r: print("[Settings] Plugin update finished:", r),
                     closeOnSuccess=True,
              )
