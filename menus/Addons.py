...
class FlexibleMenu(GUIComponent):
    ...
    def buildEntry(self):
        ...
        if "addons" not in self._cached_logos:
            logoPath = resolveFilename(SCOPE_PLUGINS, "Extensions/ElieSatPanel/assets/icons/addons.png")
...
class Addons(Screen):
    ...
    def __init__(self, session):
        ...
        # ---------------- Load Icon ----------------
        try:
            icon_path = resolveFilename(SCOPE_PLUGINS, "Extensions/ElieSatPanel/assets/icons/addons.png")
    ...
    # ---------------- INTERNET-SAFE BACKGROUND UPDATES ----------------
    def start_background_updates(self):
        ...
        # Start updates only if internet is available
    ...
    def check_plugin_update(self):
        if not has_internet():
            print("[Addons] No internet: skipping plugin update")
            return
        try:
            ...
            print("[Addons] check_plugin_update error:", e)
    ...
    def install_plugin_update(self, answer=False):
        ...
        self.session.open(
            ...
            finishedCallback=lambda r: print("[Addons] Plugin update finished:", r),
            closeOnSuccess=True,
        )
