...
class Softcams(Screen):
	def __init__(self, session):
		...
		self.intInfo()
		t = Timer(0.5, self.update_softcams)
		t.start()
	...
	def mList(self):
		...
		self.list.append((_("Audi06"), 1, _("ايميو"), a))
		self.list.append((_("Fairbird"), 2, _("ايميو"), a))
		self.list.append((_("Kite888"), 3, _("ايميو"), a))
		self.list.append((_("Levi45"), 4, _("ايميو"), a))
		self.list.append((_("Linuxsat25"), 5, _("ايميو"), a))
		self.list.append((_("Mohamed_os"), 6, _("ايميو"), a))
		self.list.append((_("Samur"), 7, _("ايميو"), a))
		self.list.append((_("Other"), 8, _("اضافات مختلفة"), a))
		self.list.append((_("Softcams-file"), 9, _("ملف الخاص بالتشفير"), a))
	...
	def select_item(self, item):
		if item:
			if item is 1:
				self.session.open(audi06)
			elif item is 2:
				self.session.open(fairbird)
			elif item is 3:
				self.session.open(kite888)
			elif item is 4:
				self.session.open(levi45)
			elif item is 5:
				self.session.open(linuxsat25)
			elif item is 6:
				self.session.open(moh)
			elif item is 7:
				self.session.open(samur)
			elif item is 8:
				self.session.open(other)
			elif item is 9:
	...
	def update_softcams(self):
		import requests
		url = 'https://raw.githubusercontent.com/eliesat/eliesatpanel/refs/heads/main/sub/softcams'
		response = requests.get(url)
		file_Path = '/usr/lib/enigma2/python/Plugins/Extensions/ElieSatPanel/sub/softcams'
...
def status_path():
	if fileExists("/usr/lib/enigma2/python/Plugins/Extensions/ElieSatPanel/sub/softcams"):
		status = "/usr/lib/enigma2/python/Plugins/Extensions/ElieSatPanel/sub/softcams"
	return status
	...
	def nList(self):
		...
		for line in open(status_path()):
			if "Package:" in line:
				...
				name2 = line.replace("\n","").split(r"(\s+)")[-1]
			elif "Status:" in line and "Aud" in line:
	...
	def nList(self):
		...
		for line in open(status_path()):
			if "Package:" in line:
				...
				name2 = line.replace("\n","").split(r"(\s+)")[-1]
			elif "Status:" in line and "Fai" in line:
				self.list.append((name1, name2, ipkminipng))
		self.list.sort()
		self["menu"].setList(self.list)
	...
	def nList(self):
		...
		for line in open(status_path()):
			if "Package:" in line:
				...
				name2 = line.replace("\n","").split(r"(\s+)")[-1]
			elif "Status:" in line and "Kit" in line:
				self.list.append((name1, name2, ipkminipng))
		self.list.sort()
		self["menu"].setList(self.list)
	...
	def nList(self):
		...
		for line in open(status_path()):
			if "Package:" in line:
				...
				name2 = line.replace("\n","").split(r"(\s+)")[-1]
			elif "Status:" in line and "Lev" in line:
				self.list.append((name1, name2, ipkminipng))
		self.list.sort()
		self["menu"].setList(self.list)
	...
	def nList(self):
		...
		for line in open(status_path()):
			if "Package:" in line:
				...
				name2 = line.replace("\n","").split(r"(\s+)")[-1]
			elif "Status:" in line and "Lin" in line:
				self.list.append((name1, name2, ipkminipng))
		self.list.sort()
		self["menu"].setList(self.list)
	...
	def nList(self):
		...
		for line in open(status_path()):
			if "Package:" in line:
				...
				name2 = line.replace("\n","").split(r"(\s+)")[-1]
			elif "Status:" in line and "Moh" in line:
				self.list.append((name1, name2, ipkminipng))
		self.list.sort()
		self["menu"].setList(self.list)
	...
	def nList(self):
		...
		for line in open(status_path()):
			if "Package:" in line:
				...
				name2 = line.replace("\n","").split(r"(\s+)")[-1]
			elif "Status:" in line and "Sam" in line:
				self.list.append((name1, name2, ipkminipng))
		self.list.sort()
		self["menu"].setList(self.list)
	...
	def nList(self):
		...
		for line in open(status_path()):
			if "Package:" in line:
				...
				name2 = line.replace("\n","").split(r"(\s+)")[-1]
			elif "Status:" in line and "Oth" in line:
				self.list.append((name1, name2, ipkminipng))
		self.list.sort()
		self["menu"].setList(self.list)
	...
	def nList(self):
		...
		for line in open(status_path()):
			if "Package:" in line:
				...
				name2 = line.replace("\n","").split(r"(\s+)")[-1]
			elif "Status:" in line and "Soft" in line:
				self.list.append((name1, name2, ipkminipng))
		self.list.sort()
		self["menu"].setList(self.list)
